...
class RuntimeConfig:
    ...
    def __init__(self):
        ...
        self.ollama_model = os.environ.get('OLLAMA_MODEL', 'qwen3:30b-a3b-instruct-2507-q4_K_M')
    ...
    def update_ollama_config(self, host: Optional[str] = None, model: Optional[str] = None):
        """
        更新Ollama配置
